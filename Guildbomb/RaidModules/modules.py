...
class RaidModules(commands.Cog):
    ...
    async def all_kick(self, ctx):
        await ctx.send(f"**INFO-KICK:** Mengeluarkan Keseluruhan Member pada Server `{ctx.guild.name}`? [y/n]")
    ...
    async def all_ban(self, ctx):
        await ctx.send(f"**INFO-BAN:** Membanned Keseluruhan Member pada Server `{ctx.guild.name}`? [y/n]")
    ...
    async def all_rename(self, ctx, newname):
        await ctx.send(f"**INFO-RENAME:** Mengganti Nama Keseluruhan Member menjadi `{newname}` di Server `{ctx.guild.name}`? [y/n]")
    ...
    async def all_dm(self, ctx, message):
        await ctx.send(f"**INFO-DM:** DM Semua Orang dengan Pesan `{message}` dari Server `{ctx.guild.name}`? [y/n]")
    ...
    async def del_emojis(self, ctx):
        await ctx.send(f"**INFO-DELETE:** Menghapus Semua Emoji dari `{ctx.guild.name}`? [y/n]")
    ...
    async def del_invites(self, ctx):
        await ctx.send(f"**INFO-DELETE:** Menghapus Semua Link Invite dari Server `{ctx.guild.name}`? [y/n]")
    ...
    async def del_channels(self, ctx):
        await ctx.send(f"**INFO-DELETE:** Menghapus Semua Channel dari Server `{ctx.guild.name}`? [y/n]")
    ...
    async def del_roles(self, ctx):
        global wait
        await ctx.send(f"**INFO-DELETE:** Menghapus Semua Role dari Server`{ctx.guild.name}`? [y/n]")
